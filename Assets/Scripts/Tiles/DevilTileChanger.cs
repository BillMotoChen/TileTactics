...
public class DevilTileChanger : MonoBehaviour
{
    private Camera mainCamera;

    private DevilLevelLoader levelLoader;
    ...
    private void Start()
    {
        levelLoader = GameObject.Find("LevelLoader").GetComponent<DevilLevelLoader>();
