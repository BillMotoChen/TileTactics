...
public class ItemManager : MonoBehaviour
{
    ...
    private GameUIButtonController gameUIButtonController;
    ...
    private void Start()
    {
        tileChanger = GetComponentInParent<TileChanger>();
        gameUIButtonController = GameObject.Find("GameUIButtonController").GetComponent<GameUIButtonController>();
